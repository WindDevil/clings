...
- **179 个练习，21 个主题**：从 `Hello, C!` 到多翻译单元、字符 I/O、
  数据结构、文件 I/O、线程和原子操作。
  `_Generic`。
...
| `20_macros` | 9 | 对象宏、函数宏、参数括号、`#`/`##`、变参宏、X-macro、宏空格、宏语句、宏与 typedef、宏副作用 |

总计 **179 个练习**。完整映射见 [docs/curriculum.md](docs/curriculum.md)
